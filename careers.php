...
<head>
    ...
    <title>Xana career</title>
</head>
    <body class="body">

    <?php include("header.php"); ?>
       
    <div class="career" style="margin-top:5%">
    <div class="career1">
      <h1>Connecting leading candidates to the world's finest science jobs</h1></div>
    
    <div class="career2">
      <input type="text" class="career-search" placeholder="Keyword (e.g. Mathematics Professor)">
      <input type="text" class="career-search" placeholder="Location (e.g. Luxembourg)">
     <select class="career-opt">
      <option value="">Within 0 miles</option>
      ...
      <button class="career-btn">Search jobs</button>
    </div>
  </div>
  </div>
  <div class="Browse">
    <div class="Browse1">
      <hr class="Browse1-hr">
      <h1 class="Browse1-h1">Browse Jobs</h1>
      <hr>
      <p class="Browse-p">Applied Science</p>
      <p class="Browse-p">Biomedicine</p>
      <p class="Browse-p">Chemistry</p>
      <p class="Browse-p">Clinical</p>
      <p class="Browse-p">Applied Science</p>
      <p class="Browse-p">Biomedicine</p>
      <p class="Browse-p">Chemistry</p>
      <p class="Browse-p">Clinical</p>
    ...
    <div class="Browse2">
      <h1 class="Browse1-h1">Featured Jobs</h1>
      <p class="Browse-p1">Full-Time Faculty Member in Molecular Agrobiolo...</p>
      <p class="Browse-p2">Beijing, China</p>
      <p class="Browse-p2">Competitive salaries and benefits pac...</p>
      <p class="Browse-p1">Full-Time Faculty Member in Molecular Agrobiolo...</p>
      <p class="Browse-p2">Beijing, China</p>
      <p class="Browse-p2">Competitive salaries and benefits pac...</p>
      <p class="Browse-p1">Full-Time Faculty Member in Molecular Agrobiolo...</p>
