...
<head>
    ...
    <title>For editorial board member</title>
...
<?php include("header.php"); ?>
    ...
    <div class="container my-5">
		...
		<nav class="navbar7">
			<div>
				<ul>
				<li><a href="#">https://bmcserieseditors.biomedcentral.com</a></li>
				</ul>
			</div>
		</nav>
		...
		<nav class="navbar8">
			<div>
				<ul>
				<li style="margin-top: 30px;">Editorial Manager:<a href="#">https://www.biomedcentral.com/p/the-bmc-series-journals/editorial-board</a></li>
				<li style="margin-top: 10px;">Springer Nature Editorial System hosted at<br> springernature.com: <a href="#"> https://editorial.springernature.com/tasks</a></li>
				</ul>
			</div>
		</nav>
		...
		<nav class="navbar8">
			<div>
				<ul>
				<li style="margin-top: 30px;"><a href="#"> https://www.biomedcentral.com/p/the-bmc-series-journals/editorial-board</a></li>
				</ul>
			</div>
			</nav>
			...
			<nav class="navbar8">
				<div>
				<ul>
				<li style="margin-top: 30px;"><a href="#"> https://www.springernature.com/gp/editors/code-of-conduct-journals</a></li>
				</ul>
				</div>
		</nav>
	</div>
