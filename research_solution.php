...
<head>
    ...
    <title>Research Solution</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
 <link rel="stylesheet" type="text/css" href="assets/css/research_solution.css">
</head>
<body class="body">
  ...
  <div class="child">
    <h1 class="child-h1">Empowering<br>you to advance<br>discovery</h1>
    <button class="child-btn">How our solutions help you →</button>
  </div>

<div class="container my-5">
<div class="child2">
    <div class="child2-1">
      <h1 class="child2-1-h1"><a href="">Accelerating Publication →</a></h1>
    </div>
    ...
    <div class="child2-2">
      ...
      <div class="child2-2-2">
        <h3 class="h3">Figshare+</h3>
        <p class="p">Publish datasets ranging from 100GB+ to 5TB or more, creating a unique DOI for your data.</p>
        <button class="button"><a href="" >More about this service <span style="margin-left: 180px;">→</span></a></button>
      </div>
      
    </div>
    <div class="child3-1">
      <h1 class="child3-1-h1"><a href="">Nurture your career  →</a></h1>
    </div>
    ...
    <div class="child4-1">
      <h1 class="child4-1-h1"><a href="">Create impact  →</a></h1>
    </div>
    <p class="child4-p">Create an impact with your research and expand it’s<br>reach beyond your peers and mentors.</p>
    <div class="child4-2">
      <div class="child4-2-1">
        <h3 class="h3">Visual Abstract</h3>
        <p class="p">Visual Abstracts are eye-catching, graphical summaries of your research. They are very effective at engaging your audience on social media channels.</p>
        <button class="button"><a href="" >More about this service <span style="margin-left: 180px;">→</span></a></button>
      </div>
      ...
      <div class="child4-1">
        <h1 class="child4-1-h1"><a href="">Inspiring Knowledge   →</a></h1>
      </div>
      <p class="child4-p">Attend interesting conferences and read up to date<br>news and information related to specific fields.</p>
      <div class="child4-2">
        <div class="child4-2-1">
        ...
        <div class="child4-2-2">
          <h3 class="h3"> xana   Conferences</h3>
